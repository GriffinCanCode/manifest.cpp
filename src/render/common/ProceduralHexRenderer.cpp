...
void ProceduralHexRenderer::update_globals(const Mat4f& view_proj, const Vec3f& camera_pos, float time) {
...
void ProceduralHexRenderer::add_instance(const Vec3f& position, const Vec4f& color, 
...
Result<void> ProceduralHexRenderer::create_buffers() {
    ...
    BufferDesc instance_desc{
        .size = MAX_INSTANCES * HexInstance::size(),
...
Result<void> ProceduralHexRenderer::create_pipeline() {
    ...
    static const VertexAttribute instance_attributes[] = {
        {.location = 0, .format = AttributeFormat::Float3, .offset = 0, .name = "instance_position"},
        {.location = 1, .format = AttributeFormat::Float4, .offset = sizeof(Vec3f), .name = "instance_color"},
        {.location = 2, .format = AttributeFormat::Float, .offset = sizeof(Vec3f) + sizeof(Vec4f), .name = "instance_elevation"},
        {.location = 3, .format = AttributeFormat::UInt, .offset = sizeof(Vec3f) + sizeof(Vec4f) + sizeof(float), .name = "instance_terrain"}
    };
